view: sav_new_non_isa_dashboard {
  ...
  measure: count {
    type: count_distinct
    drill_fields: [Channel, Channel_explicit, count]
    sql: ${TABLE}.ACCOUNT_NUMBER ;;
  }

  measure: sav_balance {
    type: sum
    drill_fields: [Channel, Channel_explicit, sav_balance]
    value_format:  "\"£\"#,##0,\" K\""
    sql: ${balance};;
  }
  ...
  measure: sav_balance_outflow {
    type: sum
    drill_fields: [Channel, Channel_explicit, sav_balance_outflow]
    value_format:  "\"£\"#,##0,\" K\""
  ...
  measure: sav_balance_inflow {
    type: sum
    drill_fields: [Channel, Channel_explicit, sav_balance_inflow]
    value_format:  "\"£\"#,##0,\" K\""
    sql: ${balance_inflow};;
  }
    ...
    measure: sav_pit_bal_acc_dt {
      type: max
      drill_fields: [Channel, Channel_explicit, sav_pit_bal_acc_dt]
      value_format:  "\"£\"#,##0,\" K\""
    ...
    measure: sav_cumulative_spend_easy_iss_1 {
      type: max
      drill_fields: [Channel, Channel_explicit, sav_cumulative_spend_easy_iss_1]
      value_format:  "\"£\"#,##0,\" K\""
    ...
    measure: sav_cumulative_spend_easy_iss_2 {
      type: max
      drill_fields: [Channel, Channel_explicit, sav_cumulative_spend_easy_iss_2]
      value_format:  "\"£\"#,##0,\" K\""
    ...
    measure: sav_cumulative_spend_easy_iss_3 {
      type: max
      drill_fields: [Channel, Channel_explicit, sav_cumulative_spend_easy_iss_3]
      value_format:  "\"£\"#,##0,\" K\""
    ...
    measure: sav_cumulative_spend_easy_iss_4 {
      type: max
      drill_fields: [Channel, Channel_explicit, sav_cumulative_spend_easy_iss_4]
      value_format:  "\"£\"#,##0,\" K\""
    ...
    measure: sav_cumulative_spend_easy_iss_5 {
      type: max
      drill_fields: [Channel, Channel_explicit, sav_cumulative_spend_easy_iss_5]
      value_format:  "\"£\"#,##0,\" K\""
    ...
    measure: sav_cumulative_spend_easy_iss_6 {
      type: max
      drill_fields: [Channel, Channel_explicit, sav_cumulative_spend_easy_iss_6]
      value_format:  "\"£\"#,##0,\" K\""
    ...
    measure: sav_cumulative_spend_easy_iss_7 {
      type: max
      drill_fields: [Channel, Channel_explicit, sav_cumulative_spend_easy_iss_7]
      value_format:  "\"£\"#,##0,\" K\""
  ...
  measure: sav_cumulative_spend_easy_iss_8 {
    type: max
    drill_fields: [Channel, Channel_explicit, sav_cumulative_spend_easy_iss_8]
    value_format:  "\"£\"#,##0,\" K\""
  ...
  measure: sav_cumulative_spend_mem_iss_1 {
      type: max
    drill_fields: [Channel, Channel_explicit, sav_cumulative_spend_mem_iss_1]
    value_format:  "\"£\"#,##0,\" K\""
    ...
    measure: sav_cumulative_spend_mem_iss_2 {
      type: max
      drill_fields: [Channel, Channel_explicit, sav_cumulative_spend_mem_iss_2]
      value_format:  "\"£\"#,##0,\" K\""
    ...
    measure: sav_cumulative_spend_mem_iss_3 {
      type: max
      drill_fields: [Channel, Channel_explicit, sav_cumulative_spend_mem_iss_3]
      value_format:  "\"£\"#,##0,\" K\""
  ...
  measure: sav_cumulative_spend_mem_iss_4 {
    type: max
    drill_fields: [Channel, Channel_explicit, sav_cumulative_spend_mem_iss_4]
    value_format:  "\"£\"#,##0,\" K\""
  ...
  measure: avg_balance_per_acc {
      type: number
    drill_fields: [Channel, Channel_explicit, avg_balance_per_acc]
    value_format:  "\"£\"#,##0,\" K\""
