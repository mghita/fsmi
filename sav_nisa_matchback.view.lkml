view: sav_nisa_matchback {
  sql_table_name: boifs.looker_sav_nisa_matchback_data;;
  ...
  measure: count_activated_account {
    type: count
  ...
  measure: pct_activated_of_all_comms {
    type: number
    value_format: "0.00\%"
    sql: 100.0*${count_activated_account}/NULLIF(${counts},0);;
  }
